...
```
presentation/01_topic_and_scope/
presentation/02_research_and_sources/
presentation/03_outline/
presentation/04_drafting/
presentation/05_revision/
presentation/06_final_polish/
```
