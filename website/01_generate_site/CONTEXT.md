...
2. From the repository root, run `/orchestra/environments/agents/website/bin/python website/01_generate_site/references/build_site.py` to rebuild the website.
