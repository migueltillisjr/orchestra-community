...
- `website/03_refine_site/output/REFINE_CHANGES.md` must include the review date, evaluation source path, final output path, each failed criterion or gate, the observed failure, the implemented change, verification evidence, and unresolved content, rights, privacy, or approval gaps.
