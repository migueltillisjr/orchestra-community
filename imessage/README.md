...
Update these files in `imessage/shared/references/` before running:

| File | What to put here |
|------|-----------------|
| `imessage/shared/references/REQUIREMENTS.md` | Presentation specs (purpose, audience, tone, length) |
| `imessage/shared/references/RUBRIC.md` | Grading rubric formatted as a markdown table |
| `imessage/shared/references/GLOBAL_CONTEXT.md` | Source content (e.g., a blog post) the presentation is based on |
| `imessage/shared/references/TEMPLATE.html` | HTML slideshow template — the final output is generated from this |
...
| File | Purpose |
|------|---------|
| `imessage/shared/references/REQUIREMENTS.md` | Presentation specs — purpose, audience, tone, length, visual style |
| `imessage/shared/references/RUBRIC.md` | Grading criteria for the presentation |
| `imessage/shared/references/GLOBAL_CONTEXT.md` | The source content (blog post, brief, etc.) to base the presentation on |
| `imessage/shared/references/TEMPLATE.html` | HTML slideshow template — stage 8 copies this and replaces slide content |
| `imessage/08_final_assembly/references/AI_DEFENSE.md` | (Optional) Writing style rules for natural-sounding content |
...
```
imessage/01_purpose/output/purpose.md
imessage/02_audience/output/audience.md
imessage/03_title/output/title.md
imessage/04_structure/output/structure.md
imessage/05_slide_content/output/slides.md
imessage/06_visuals/output/visuals.md
imessage/07_speaker_notes/output/speaker_notes.md
imessage/08_final_assembly/output/final_presentation.html
imessage/09_evaluation/output/evaluation.md
imessage/10_revision_pass/output/revised_presentation.html
```

The final deliverable is `imessage/10_revision_pass/output/revised_presentation.html` — a self-contained HTML slideshow you can open directly in a browser. It includes keyboard navigation (← → arrows, Space), a progress bar, slide dots, fullscreen mode (F key), and a print-friendly layout.
...
./09_evaluation/run_eval.sh imessage/10_revision_pass/output/revised_presentation.md
...
├── imessage/shared/references/          # Presentation inputs (update per task)
│   ├── REQUIREMENTS.md
│   ├── RUBRIC.md
│   ├── GLOBAL_CONTEXT.md
│   └── TEMPLATE.html
├── imessage/01_purpose/                 # Stage 1: clarify purpose
├── imessage/02_audience/                # Stage 2: define audience
├── imessage/03_title/                   # Stage 3: create title
├── imessage/04_structure/               # Stage 4: build slide structure
├── imessage/05_slide_content/           # Stage 5: write slide content
├── imessage/06_visuals/                 # Stage 6: visual suggestions
├── imessage/07_speaker_notes/           # Stage 7: speaker notes (optional)
├── imessage/08_final_assembly/          # Stage 8: assemble final presentation
├── imessage/09_evaluation/              # Stage 9: grade against rubric
├── imessage/10_revision_pass/           # Stage 10: fix evaluation issues
├── scripts/
