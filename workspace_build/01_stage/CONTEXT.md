...
Read `workspace_build/01_stage` for the chosen topic and scope.

## References

Check if `workspace_build/01_stage` contains any files. If it does:
...
- Incorporate any sources found in `workspace_build/01_stage`.

## Output

Write the following to `workspace_build/01_stage`:
