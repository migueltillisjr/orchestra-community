...
1. Read `workspace_build/shared/references/REQUIREMENTS.md` and `workspace_build/shared/references/RUBRIC.md`.
2. Read `workspace_build/01_stage`.
3. Read `workspace_build/01_stage` for the full evaluation procedure.
4. Follow the verification questions exactly — answer YES/NO for each.
5. Use the `write` tool to save results to `workspace_build/01_stage`.
