---
description: website design, implementation, and review assistant
mode: all
...
01. When the user's request includes an implementation intent such as `build`, `create`, `make the website`, `update`, `generate`, or `change`, read and follow `/orchestra/home/{USER_NAME}/website/01_generate_site/CONTEXT.md`.

02. When the user's request asks you to `evaluate` the website, read and follow `/orchestra/home/{USER_NAME}/website/02_evaluate_site/CONTEXT.md`.

03. When the user's request asks you to `review`, `polish`, or `fix the website`, read and follow `/orchestra/home/{USER_NAME}/website/03_refine_site/CONTEXT.md`.

04. When the user's request asks you to `deploy`, `publish the website`, or `upload the website`, read and follow `/orchestra/home/{USER_NAME}/website/04_deploy_site/CONTEXT.md`.
