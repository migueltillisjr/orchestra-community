...
| File | Purpose |
|------|---------|
| `workspace_build/shared/references/REQUIREMENTS.md` | Assignment prompt, task instructions, and submission guidelines |
| `workspace_build/shared/references/RUBRIC.md` | Grading rubric with criteria for each section |
...
|------|-------|---------|---------|
| 1 | 🎯 Topic & Scope | - | `workspace_build/01_stage` |
| 2 | 🔍 Research & Sources | - | `workspace_build/01_stage` |
| 3 | 🏗️ Outline | Build a structured outline with introduction, body sections, and conclusion | `workspace_build/01_stage` |
| 4 | ✍️ Drafting | Write the report section by section, checking in with the user along the way | `workspace_build/01_stage` |
| 5 | 🔄 Revision | Review for argument strength, clarity, grammar, and citation accuracy | `workspace_build/01_stage` |
| 6 | 📄 Final Polish | Format, finalize citations/bibliography, and produce the finished report | `workspace_build/01_stage` |
| 7 | ✅ Evaluation | **Handled by `run_report.sh` — do not run this stage yourself** | `workspace_build/01_stage` |
| 8 | 🔧 Revision Pass | **Handled by `run_report.sh` — do not run this stage yourself** | `workspace_build/01_stage` |
...
|------|-------------------|-------------------|
| 1 | `workspace_build/shared/references/` | `workspace_build/01_stage` |
| 2 | `workspace_build/01_stage` | `workspace_build/01_stage`, `frameworks.md` |
| 3 | `workspace_build/01_stage`, `frameworks.md` | `workspace_build/01_stage` |
| 4 | `workspace_build/01_stage` | `workspace_build/01_stage` |
| 5 | `workspace_build/01_stage` | `workspace_build/01_stage`, `revision_notes.md` |
| 6 | `workspace_build/01_stage` | `workspace_build/01_stage` |
| 7 | `workspace_build/01_stage` | `workspace_build/01_stage` |
| 8 | `workspace_build/01_stage` + `workspace_build/01_stage` | `workspace_build/01_stage` |
...
**Example:** After completing Step 1, use `write` to create `workspace_build/01_stage` with the topic summary. Then read that file when starting Step 2.
...
| User says... | Action |
|--------------|--------|
| "Let's start" / "build report" / topic description | Read `workspace_build/shared/references/` first, then begin at Step 1 using the info already available |
